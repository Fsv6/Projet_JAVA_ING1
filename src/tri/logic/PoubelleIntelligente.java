...
public class PoubelleIntelligente {
 ...
 // Méthode pour vérifier si la poubelle est pleine
    public boolean estPleine() {
        for (Bac bac : bacs) {
            if (!bac.estPlein()) {
                return false; // Si un bac n'est pas plein, la poubelle n'est pas pleine
            }
        }
        return true; // Tous les bacs sont pleins
    }
