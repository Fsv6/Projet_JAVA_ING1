    ...
    public List<Contrat> getAllContrats() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
        	...
        	while (rs.next()) {
        	    ...
        	    LocalDate dateDebut = rs.getDate("dateDebutContrat").toLocalDate();
        	    LocalDate dateFin = rs.getDate("dateFinContrat").toLocalDate();
        	    List<String> listeCatProduits = Arrays.asList(rs.getString("listeCatProduits").split(","));

        	    Contrat contrat = new Contrat(idCentreTri, idCommerce, dateDebut, dateFin, listeCatProduits);
